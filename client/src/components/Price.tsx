...
const tiers = [
  {
    ...
    href: '#',
    priceMonthly: 'Rp.0',
    description: "The perfect plan if you're just getting started with resume analysis.",
    features: [
  ...
  },
  {
    ...
    description: 'Dedicated support and unlimited analysis for serious job seekers.',
    features: [
...
export default function Pricing() {
  ...
  return (
    <div id="price" className="relative isolate bg-muted px-6 py-24 sm:py-32 lg:px-8">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
        Choose an affordable plan that's packed with the best features for landing your dream job.
      </p>
          ...
          return (
            <div
              ...
              className={classNames(
                isHovered ? 'bg-blue-600 shadow-2xl scale-105' : 'bg-blue-500 scale-100 sm:mx-8 lg:mx-0',
                isHovered
                ? 'z-10'
                : tierIdx === 0
            ...
            >
              ...
              <p className="mt-4 flex items-baseline gap-x-2">
                ...
                {tier.name === 'Pro Plan' && <span className="text-base text-blue-200">/month</span>}
              </p>
              <p className="mt-6 text-base leading-7 text-blue-100">
                {tier.description}
              </p>
              <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-blue-100 sm:mt-10">
